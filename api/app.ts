...
function getAi(): GoogleGenAI {
  if (!aiClient) {
    ...
    if (!apiKey) {
      throw new Error("La chiave API 'GEMINI_API_KEY' non è configurata. Aggiungila nelle variabili d'ambiente di Vercel (Environment Variables) per abilitare il rendering AI.");
    }
